...
/**
 ...
 @param i bitmask of the source orbital (bit to shift from)
 @param j bitmask of the destination orbital (bit to shift to)
 */
...
/**
 ...
 @param i bitmask of the first orbital to annihilate
 @param j bitmask of the second orbital to annihilate
 */
...
/**
 turn set bits at i and j into zero.
 returns the phase (+1 or -1) generated by the operation, or zero if the operation is impossible
 @param i bitmask of the first orbital to create
 @param j bitmask of the second orbital to create
 */
