...
namespace ED {
  void global_parameter_init()
  {
    ...
    new_global_double(1.0e-6,"accur_Davidson","maximum norm of residuals in the Davidson-Liu algorithm");
    new_global_double(1e-12,"accur_deflation","norm below which a vector is deflated in the band Lanczos method");
