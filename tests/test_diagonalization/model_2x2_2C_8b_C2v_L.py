...
hopping_operator('tc', [2,0,0], -1, orb1=1, orb2=1) 
hopping_operator('tc', [0,2,0], -1, orb1=1, orb2=1) 

hopping_operator('tpp', [1,1,0], -1, orb1=2, orb2=3)
hopping_operator('tpp', [1,1,0], -1, orb1=3, orb2=2)
hopping_operator('tpp', [-1,1,0], 1, orb1=2, orb2=3)
hopping_operator('tpp', [-1,1,0], 1, orb1=3, orb2=2)
hopping_operator('tppp', [2,0,0], 1, orb1=2, orb2=2)
hopping_operator('tppp', [0,2,0], 1, orb1=3, orb2=3)

hopping_operator('e',[0,0,0],1,orb1=2,orb2=2,tau=0,sigma=0)
hopping_operator('e',[0,0,0],1,orb1=3,orb2=3,tau=0,sigma=0)

hopping_operator('tpd', [1,0,0], 1, orb1=1, orb2=2)
hopping_operator('tpd', [1,0,0], -1, orb1=2, orb2=1)
hopping_operator('tpd', [0,1,0], 1, orb1=1, orb2=3)
hopping_operator('tpd', [0,1,0], -1, orb1=3, orb2=1)

anomalous_operator('D', [2,0,0], 1, orb1=1, orb2=1) # NN singlet
anomalous_operator('D', [0,2,0], -1, orb1=1, orb2=1) # NN singlet
